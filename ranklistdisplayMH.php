...
LEFT JOIN class_details cd ON cd.classid=cc.classid where hsr.admn_status in ('ranked') AND  cd.courseid in('BTECH','BARCH') and sd.gender='M' order by hsr.final_rank ";
