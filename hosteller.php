<!DOCTYPE html>
 ...
 <?php
	...
	?>		 
		...
		<div class="container">
			<form name="frm1" method="post" action="hosteller.php">
<table align="centre">
	<tr><td>
...
$qry_rank="SELECT * from hostel_student_details hsd 
LEFT JOIN stud_details sd  ON sd.admissionno=hsd.ADMNO
LEFT JOIN current_class cc ON cc.studid=sd.admissionno 
LEFT JOIN class_details cd ON cd.classid=cc.classid 
LEFT JOIN hostel_stud_reg hsr ON hsr.ADMNO=hsd.ADMNO
LEFT JOIN hostel_rit hr ON hr.hosid=hsd.hos_id
 where hsd.admn_status in ('allocated') AND hr.hosname='".$_POST['hos_name']."'";
