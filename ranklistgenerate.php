...
$qrymin_d="select min(distance) from hostel_stud_reg where admn_status='submitted'";
...
$qrymax_d="select max(distance) from hostel_stud_reg where admn_status='submitted'";
...
*/
$qrymin_rank="select min(Entrance_rank) from hostel_stud_reg where admn_status='submitted'";
...
$qrymax_rank="select max(Entrance_rank) from hostel_stud_reg where admn_status='submitted'";
...
$qry_rank="select * from stud_details sd,hostel_stud_reg where sd.admissionno=hostel_stud_reg.ADMNO and hostel_stud_reg.admn_status='submitted'" ;
...
if ($res_update) {
	...
	echo '<script type="text/javascript">alert("Ranklist generated");window.location=\'ranklistdisplay.php\';</script>';
}
else
{
	//echo "udation failed";
